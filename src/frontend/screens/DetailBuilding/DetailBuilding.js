		...
		return (
			<>
				...
				<div className="flex flex-col font-primary bg-slate-200">
					<h1 className="text-2xl text-center font-bold mt-20 mx-10 p-2 bg-white rounded">
						BILOCALE IN PERIFERIA A MILANO
					</h1>
					<button onClick={this.openCanvas}>3D View AVAILABLE</button>
					...
					<div className="flex flex-row bg-white rounded justify-center mx-10">
						...
						<div className={"flex flex-col h-60 w-1/2 m-2 p-2"}>
							<div className="flex flex-row">
								<FontAwesomeIcon
									className={"h-6 color-primary"}
									icon={faMapMarkerAlt}
								/>
								<h1 className="text-xl font-bold mx-2 color-secondary">
									MILANO
								</h1>
								<FontAwesomeIcon
