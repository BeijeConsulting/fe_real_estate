    ...
    <>
      ...
      <div className="ourvalues-container">
        ...
        <div className="ourvalues-text">
          <p className="lg:text-3xl lg:font-bold lg:ml-20 lg:mt-12 relative sm:text-xl sm:ml-8 sm:"> I VALORI IN CUI CREDIAMO </p>
          <p className="lg:text-lg lg:italic lg:mt-36 lg:p-3 lg:leading-9 sm:text-base sm:mt-0 sm:italic"> Crediamo fortemente in una visione globale del mercato immobiliare. Noi di Domus.it mettiamo al centro la persona: nella nostra azienda tutti hanno un grande valore intrinseco e ci teniamo ad avere un team di persone provenienti da diverse culture e background sociali.
          </p>
        </div>
